<template>
    <div>
        <div class="max-w-sm p-6 bg-[#eee] border border-[#ccc] rounded-sm shadow dark:bg-[#111] dark:border-[#333]">
            ...
            <div class="p-5">
                <span href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-[#111] dark:text-[#eee]">{{ title }}</h5>
                </span>
                <p class="mb-3 font-normal text-[#111] dark:text-[#eee]">Release Date: {{ release_date }}</p>
